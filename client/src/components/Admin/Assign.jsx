...
export default function Assign() {
  ...
  const getHistorique = () => {
    axios.get(URL + "historique").then((res) => {
...
//   console.log(data);
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.put(URL + "historique/"+data._id, data)
    .then((res) => {
      console.log(res.data);
      setShowModal(false);
    })
    ...
    <div>
      <div className="flex justify-end mb-10">
        <button
          ...
          type="button"
        onClick={() => navigate("/dashboard/add-assigner")}
        >
          Action
        </button>
        {/* <!-- Dropdown menu --> */}
        ...
        {historique.map((h, i) => (
          <tbody>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4">{h.formation.name}</td>
            ...
            <div className="relative w-auto max-w-3xl mx-auto my-6">
              ...
              <div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid rounded-t border-slate-200 ">
                  <h3 className="text-3xl font-semibold">Asigner une fomation à un Formateur</h3>
                  <button
